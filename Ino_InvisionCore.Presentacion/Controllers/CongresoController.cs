...
namespace Ino_InvisionCore.Presentacion.Controllers
{
    ...
    public class CongresoController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult EventoAsistenciaRegistrar([FromBody]NuevaAsistencia nuevaAsistencia)
        {
            var respuesta = _servicioDeCongreso.EventoAsistenciaRegistrar(nuevaAsistencia);
