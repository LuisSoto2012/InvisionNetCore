...
namespace Ino_InvisionCore.Dominio.Contratos.Helpers.AccidenteDeTrabajo.Respuestas
{
    public class AccidenteDeTrabajoDto
    {
        ...
        public string FechaNacimiento_Accidentado { get; set; }
        ...
        public string FechaInvestigacion_Accidente { get; set; }
