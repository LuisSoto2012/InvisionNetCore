...
{
    public class EvaluacionPreAnestesicaDto
    {
        ...
        public string LaboratorioImagen_FechaExamen1 { get; set; }
        ...
        public string LaboratorioImagen_FechaExamen2 { get; set; }
        public string LaboratorioImagen_RxTorax { get; set; }
        public string LaboratorioImagen_FechaExamen3 { get; set; }
